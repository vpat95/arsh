...
const Contact = () => {
  return (
    <section id="contact" className="section-padding bg-contractor-gray-light/30">
      <div className="container-width">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Get in touch today for your free estimate. We're here to make your renovation dreams come true.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <Card className="contractor-card-gradient border-0">
            <CardContent className="p-8">
              <h3 className="text-2xl font-semibold text-foreground mb-6">Get Your Free Estimate</h3>
              <form className="space-y-6">
                ...
                <Button variant="secondary" size="lg" className="w-full contractor-button-shadow">
          ...
          <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-muted-foreground">Bergen County, NJ</div>
                      <div className="text-sm text-muted-foreground">Fair Lawn and surrounding areas</div>
                    </div>
                  </div>
            ...
            <Card className="contractor-card-gradient border-0">
              <CardContent className="p-8 text-center">
                <h3 className="text-xl font-semibold text-foreground mb-4">Follow Our Work</h3>
